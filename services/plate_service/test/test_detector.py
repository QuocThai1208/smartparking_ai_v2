...
import os
import time
from lp_recognition.detector import PlateDetector
from lp_recognition.preprocessor import PlatePreprocessor
from lp_recognition.recognizer import PlateRecognizer
